...
#         if value_cb['price_percentage_change_24h'] != '' and str(value_cb['base_currency_id']) != None:
...
# print(binance_hike_cap)
# print(binance_drop_cap)
...
a = ['BTCTUSD', 'ETHUSDT', 'XRPUSDT', 'UNICUMUSDT']
def name_edit(name):
    a = name[:-4]
    b = '-'
    c = name[-4:]
